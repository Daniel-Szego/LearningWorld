...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WikiControl.ascx.cs" Inherits="Lernwelt.SharePoint.Web.Controls.WikiControl" %>
       ...
       <ProgressTemplate>
        ...
        <table>
            <tbody>
                <tr>
                    <td>
                        <asp:Literal runat="server" Text="<%$Resources:Lernwelt.SharePoint,Control_Wiki_FieldTitle_PageTitle%>" />
                    </td>
                    <td>
                        <asp:TextBox ID="txtPageTitle" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$Resources:Lernwelt.SharePoint,PageTitle_Not_Found_Error%>" Text="*"
                        ControlToValidate="txtPageTitle" ValidationGroup="ErrorGroup1"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Literal runat="server" Text="<%$Resources:Lernwelt.SharePoint,Control_Wiki_FieldTitle_PageDescription%>" />
                    </td>
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<%$Resources:Lernwelt.SharePoint,Description_Not_Found_Error%>" Text="*"
                        ControlToValidate="rtxDescription" ValidationGroup="ErrorGroup1"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Literal ID="Literal2" runat="server" Text="<%$Resources:Lernwelt.SharePoint,Control_Wiki_FieldTitle_PageLayout%>" />
                    </td>
                    <td>
                        <asp:ListBox ID="lsbLayouts" runat="server" Width="350px">
<%--                            <asp:ListItem Value="1" Text="(Article Page) Image on left" />
                            <asp:ListItem Value="2" Text="(Enterprise Wiki page) PPM Wiki Page" />
                            <asp:ListItem Value="3" Text="(Project Page) Basic Project Page" />--%>
                        </asp:ListBox>
                    </td>
                </tr>
                <tr>
...
<%--                        <asp:RadioButtonList ID="rbRating" runat="server">
                    ...
                    <tr>
                        <td>
                            <asp:Literal ID="Literal1" runat="server" Text="<%$Resources:Lernwelt.SharePoint, Control_Wiki_FieldTitle_FaqKeyword%>"></asp:Literal>
                        </td>
...
--%>                                </td>
                            ...
                            <tr>
                                 <td>
                                      <asp:DropDownList ID="drpWikiItems" runat="server" Width="350px">
                                      </asp:DropDownList>
                                 </td>
                            </tr>
                            </table>
                ...
                <tr>
                     <td>
                         <asp:Literal ID="Literal3" runat="server" Text="<%$Resources:Lernwelt.SharePoint, Control_Wiki_FieldTitle_StartPage%>"></asp:Literal>
                     </td>
                     <td>
                        <asp:CheckBox runat="server" ID="chkStartPage" />
                     </td>
                </tr>
                <tr>
                    <td></td>
