...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WikiPropertyControl.ascx.cs" Inherits="Lernwelt.SharePoint.Web.Controls.WikiPropertyControl" %>
                                ...
                                <table cellspacing="0" border="0" style="border-width: 0px; width: 100%; border-collapse: collapse;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="UserSectionHead">
                                                    <asp:Label ID="Label4" runat="server" AssociatedControlID="ddlDescription" EnableViewState="False" Text="<%$Resources:Lernwelt.SharePoint,Control_Documents_FieldTitle_ShortDescription%>"></asp:Label>
                                                </div>
                                                <div class="UserSectionBody">
                                                    <div class="UserControlGroup">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="UserSectionHead">
                                                    <asp:Label ID="Label3" runat="server" AssociatedControlID="ddlPageLink" EnableViewState="False" Text="<%$Resources:Lernwelt.SharePoint,Control_PageLink%>"></asp:Label>
                                                </div>
                                                <div class="UserSectionBody">
                                                    <div class="UserControlGroup">
