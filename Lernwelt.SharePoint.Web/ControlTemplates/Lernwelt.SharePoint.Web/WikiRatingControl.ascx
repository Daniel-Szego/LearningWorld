...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WikiRatingControl.ascx.cs" Inherits="Lernwelt.SharePoint.Web.ControlTemplates.Lernwelt.SharePoint.Web.WikiRatingControl" %>
