...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FaqControl.ascx.cs" Inherits="Lernwelt.SharePoint.Web.Controls.FaqControl" %>
...
<script type="text/javascript">
    ...
    prm.add_endRequest(function () {
     ...
     <asp:UpdateProgress ID="progressUpdate3" runat="server" DisplayAfter="1000" AssociatedUpdatePanelID="UpdatePanel2">
       <ProgressTemplate>
        ...
        <table>
            <tbody>
                <tr>
                    <td>
                        <asp:Literal runat="server" Text="<%$Resources:Lernwelt.SharePoint,Control_Faq_FieldTitle_Question%>" />
                    </td>
                    <td>
                        <asp:TextBox ID="txtQuestion" runat="server"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="<%$Resources:Lernwelt.SharePoint,Question_Not_Found_Error%>" Text="*"
                        ControlToValidate="txtQuestion" ValidationGroup="ErrorGroup1"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Literal runat="server" Text="<%$Resources:Lernwelt.SharePoint,Control_Faq_FieldTitle_Answer%>" />
                    </td>
                    <td>
                        <SharePoint:InputFormTextBox ID="rtxAnswer" class="ms-input" runat="server" Rows="25" Columns="40" RichText="True" TextMode="MultiLine" RichTextMode="FullHtml" />
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="<%$Resources:Lernwelt.SharePoint,Answer_Not_Found_Error%>" Text="*"
                        ControlToValidate="rtxAnswer" ValidationGroup="ErrorGroup1"/>
                    </td>
                </tr>
                <tr>
                    <td>
...
<%--                <asp:Panel ID="pnlKeywordSearch" runat="server" Visible="True">--%>
                    <tr>
                        <td>
                            <asp:Literal ID="Literal1" runat="server" Text="<%$Resources:Lernwelt.SharePoint, Control_Faq_FieldTitle_FaqKeyword%>"></asp:Literal>
                        </td>
...
--%>
                            ...
                            <tr>
                            <td>
                                <asp:Button ID="btnRefresh" runat="server" Text="<%$Resources:Lernwelt.SharePoint, Control_FAQ_FieldTitle_Refresh%>" onclick="btnRefresh_Click"></asp:Button>
                            </td>
                            </tr>
                            <tr>
                                <td>
                                    <asp:DropDownList ID="drpFaqItems" runat="server" Width="350px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                     </table>
