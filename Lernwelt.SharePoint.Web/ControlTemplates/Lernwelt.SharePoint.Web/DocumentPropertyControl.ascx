...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocumentPropertyControl.ascx.cs" Inherits="Lernwelt.SharePoint.Web.Controls.DocumentPropertyControl" %>
                                ...
                                <table cellspacing="0" border="0" style="border-width: 0px; width: 100%; border-collapse: collapse;">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="UserSectionHead">
                                                    <asp:Label ID="Label1" runat="server" AssociatedControlID="ddlName" EnableViewState="False" Text="<%$Resources:Lernwelt.SharePoint,Control_Documents_FieldTitle_Name%>"></asp:Label>
                                                </div>
                                                <div class="UserSectionBody">
                                                    <div class="UserControlGroup">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="UserSectionHead">
                                                    <asp:Label ID="Label2" runat="server" AssociatedControlID="ddlTitle" EnableViewState="False" Text="<%$Resources:Lernwelt.SharePoint,Control_Documents_FieldTitle_Title%>"></asp:Label>
                                                </div>
                                                <div class="UserSectionBody">
                                                    <div class="UserControlGroup">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="UserSectionHead">
                                                    <asp:Label ID="Label3" runat="server" AssociatedControlID="ddlDocumenttype" EnableViewState="False" Text="<%$Resources:Lernwelt.SharePoint,Control_Documents_FieldTitle_Documenttype%>"></asp:Label>
                                                </div>
                                                <div class="UserSectionBody">
                                                    <div class="UserControlGroup">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="UserSectionHead">
                                                    <asp:Label ID="Label4" runat="server" AssociatedControlID="ddlShortDescription" EnableViewState="False" Text="<%$Resources:Lernwelt.SharePoint,Control_Documents_FieldTitle_ShortDescription%>"></asp:Label>
                                                </div>
                                                <div class="UserSectionBody">
                                                    <div class="UserControlGroup">
                                                        <asp:DropDownList ID="ddlShortDescription" runat="server"></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div style="width: 100%" class="UserDottedLine"></div>
                                            </td>
...
<%--                                         <tr>
                                            <td>
                                                <div class="UserSectionHead">
                                                    <asp:Label ID="Label11" runat="server" AssociatedControlID="ddlNoOfRatings" EnableViewState="False" Text="<%$Resources:Lernwelt.SharePoint,Control_Documents_No_Of_Ratings%>"></asp:Label>
                                                </div>
                                                <div class="UserSectionBody">
                                                    <div class="UserControlGroup">
