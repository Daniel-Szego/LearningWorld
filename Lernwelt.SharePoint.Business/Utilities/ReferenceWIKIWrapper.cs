...
{
    public class ReferenceWIKIWrapper
    {
        ...
        public ReferenceWIKIWrapper(string _fileName, Guid _columnID, string _columnName, int _intId)
        {
            //fileID = _fileID;
            fileName = _fileName;
            columnID = _columnID;
        ...
        public ReferenceWIKIWrapper(string _fileID, string _fileName, Guid _columnID, string _columnName)
        {
