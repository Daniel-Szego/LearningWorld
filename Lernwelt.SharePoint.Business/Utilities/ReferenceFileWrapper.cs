...
{
    public class ReferenceFileWrapper
    {
        ...
        public ReferenceFileWrapper(string _fileName, Guid _columnID, string _columnName, int _intId)
        {
            //fileID = _fileID;
            fileName = _fileName;
            columnID = _columnID;
        ...
        public ReferenceFileWrapper(string _fileID, string _fileName, Guid _columnID, string _columnName)
        {
